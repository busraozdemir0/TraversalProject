...
namespace TraversalApiProject
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // farklý projelerden gelen isteklere cevap vermek için CORS yapýsý kullanýlýr.
            services.AddCors(opt =>
            {
                opt.AddPolicy("TraversalApiCors", opts =>
                {
                    opts.AllowAnyOrigin().AllowAnyHeader().AllowAnyMethod();  // AllowAnyOrigin - herhangi bir isteðe izin ver
                });
            });
        }
